...
#SBATCH --job-name=blastn_10NT       # name of the task as displayed in squeue & sacc, also encouraged as srun optional parameter
...
input_file="/shared/projects/2314_medbioinfo/magnus/MedBioinfo/data/merged_pairs/ERR6913277.flash.extendedFrags_10.fna"
...
srun --job-name=blastn_10NT blastn -num_threads ${SLURM_CPUS_PER_TASK} -query ${input_file} -db ${db} -evalue 1E-10 -max_target_seqs 5 -outfmt 6 -perc_identity 75 -out ${output_file}_10.out
