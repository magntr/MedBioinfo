...
#SBATCH --job-name=kraken2_one_sample      # name of the task as displayed in squeue & sacc, also encouraged as srun optional parameter
...
workdir="/shared/projects/2314_medbioinfo/magnus/MedBioinfo/analyses/kraken2"
datadir="/shared/projects/2314_medbioinfo/magnus/MedBioinfo/data/sra_fastq"
input_file1="/shared/projects/2314_medbioinfo/magnus/MedBioinfo/data/sra_fastq/ERR6913276_1.fastq.gz"
input_file2="/shared/projects/2314_medbioinfo/magnus/MedBioinfo/data/sra_fastq/ERR6913276_2.fastq.gz"

output_file=${workdir}/fastq_one_sample_kraken2
...
srun --job-name=kraken2_one_sample kraken2 -db ${db} --threads ${SLURM_CPUS_PER_TASK} --paired ${input_file1} ${input_file2} --output ${output_file}_out --report ${output_file}_report
